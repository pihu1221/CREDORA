...
export function DiagnosticTest({ onComplete, userName }: DiagnosticTestProps) {
  ...
  // Mocking 30 Medium DSA questions for performance & reliability
  // In a real app, these could be fetched from a DB or generated once.
  const staticQuestions: Question[] = [
    ...
    // Adding more questions to reach 30...
    {
      ...
      description: "In a standard Trie for English alphabet lowercase letters, how many children does each node typically have?",
      options: ["2", "10", "26", "Variable"],
      correctAnswer: 2,
      topic: "Trie",
      difficulty: "Medium",
      explanation: "Each node represents a character, so for 'a-z' it usually has 26 pointers."
    },
    {
      id: 7,
      title: "Quick Sort Partition",
      description: "What is the worst-case time complexity of Quick Sort?",
      options: ["O(N log N)", "O(N^2)", "O(N)", "O(log N)"],
      correctAnswer: 1,
      topic: "Sorting",
      difficulty: "Medium",
      explanation: "Worst case occurs when the pivot always picks the smallest or largest element, leading to O(N^2)."
    },
    {
      id: 8,
      title: "Heap Operations",
      description: "What is the time complexity to insert an element into a Binary Max-Heap of size N?",
      options: ["O(N)", "O(log N)", "O(1)", "O(N log N)"],
      correctAnswer: 1,
      topic: "Heaps",
      difficulty: "Medium",
      explanation: "Insertion involves adding at the leaf and 'bubbling up', taking O(log N) heights."
    },
    {
      id: 9,
      title: "Hash Collision: Chaining",
      description: "If a hash table uses chaining with linked lists, what is the average time complexity for a search operation if the load factor is constant?",
      options: ["O(1)", "O(N)", "O(log N)", "O(N log N)"],
      correctAnswer: 0,
      topic: "Hashing",
      difficulty: "Medium",
      explanation: "With a good hash function and constant load factor, average search is O(1)."
    },
    {
      id: 10,
      title: "Balanced Trees",
      description: "Which of the following is NOT a self-balancing binary search tree?",
      options: ["AVL Tree", "Red-Black Tree", "Splay Tree", "Segment Tree"],
      correctAnswer: 3,
      topic: "Trees",
      difficulty: "Medium",
      explanation: "Segment trees are used for range queries, not specifically for maintaining balanced search properties like AVL/RB trees."
    },
    {
      id: 11,
      title: "Topological Sort",
      description: "Topological sort is possible for which type of graphs?",
      options: ["Directed Acyclic Graph (DAG)", "Undirected Graph", "Any Directed Graph", "Complete Graph"],
      correctAnswer: 0,
      topic: "Graphs",
      difficulty: "Medium",
      explanation: "Topological sort requires the graph to be directed and have no cycles (DAG)."
    },
    {
      id: 12,
      title: "Two Pointers: 3Sum",
      description: "For the 3Sum problem (finding triplets that sum up to zero), what is the optimal time complexity?",
      options: ["O(N)", "O(N log N)", "O(N^2)", "O(N^3)"],
      correctAnswer: 2,
      topic: "Two Pointers",
      difficulty: "Medium",
      explanation: "By sorting and using two pointers for each element, we get O(N^2)."
    },
    {
      id: 13,
      title: "Recursion: Fibonacci",
      description: "What is the time complexity of the naive recursive Fibonacci implementation (without memoization)?",
      options: ["O(N)", "O(N^2)", "O(2^N)", "O(log N)"],
      correctAnswer: 2,
      topic: "Recursion",
      difficulty: "Medium",
      explanation: "Each call branches into two more, leading to an exponential O(2^N) complexity."
    },
    {
      id: 14,
      title: "Stack: Balanced Parentheses",
      description: "Which data structure is most suitable to check if parentheses in a string are balanced?",
      options: ["Queue", "Stack", "Priority Queue", "Heap"],
      correctAnswer: 1,
      topic: "Stacks",
      difficulty: "Medium",
      explanation: "A stack allows LIFO processing, perfect for matching the most recent opening bracket with a closing one."
    },
    {
      id: 15,
      title: "Graph: Dijkstra's",
      description: "Dijkstra's algorithm fails for graphs having:",
      options: ["Negative weight edges", "Cycles", "Multiple edges", "Isolated nodes"],
      correctAnswer: 0,
      topic: "Graphs",
      difficulty: "Medium",
      explanation: "Dijkstra assumes that once a node is visited, its shortest path is found, which isn't true if negative weights can reduce the path later."
    },
    {
       id: 16,
       title: "Longest Increasing Subsequence",
       description: "What is the time complexity of the most efficient O(N log N) solution for LIS?",
       options: ["O(N^2)", "O(N log N)", "O(N)", "O(2^N)"],
       correctAnswer: 1,
       topic: "DP/Binary Search",
       difficulty: "Medium",
       explanation: "Using binary search with an auxiliary array allows finding LIS in O(N log N)."
    },
    {
       id: 17,
       title: "Breadth First Search",
       description: "Which data structure is used to implement BFS?",
       options: ["Stack", "Queue", "Priority Queue", "Tree"],
       correctAnswer: 1,
       topic: "Graphs",
       difficulty: "Medium",
       explanation: "BFS uses a Queue to process nodes level by level (FIFO)."
    },
    {
       id: 18,
       title: "Memory: Caching",
       description: "Which replacement policy is most commonly used in cache systems?",
       options: ["FIFO", "LIFO", "LRU (Least Recently Used)", "Random"],
       correctAnswer: 2,
       topic: "Systems/Data Structures",
       difficulty: "Medium",
       explanation: "LRU is widely used as it assumes recently accessed items will be accessed again soon."
    },
    {
       id: 19,
       title: "Sorting: Merge Sort",
       description: "Is Merge Sort a stable sorting algorithm?",
       options: ["Yes", "No", "Depends on Implementation", "Only for small N"],
       correctAnswer: 0,
       topic: "Sorting",
       difficulty: "Medium",
       explanation: "Yes, Merge Sort maintains the relative order of elements with equal keys."
    },
    {
       id: 20,
       title: "Bit Manipulation: Power of 2",
       description: "Which bitwise expression checks if an integer N is a power of 2?",
       options: ["N & (N+1) == 0", "N & (N-1) == 0", "N | (N-1) == 0", "N ^ (N-1) == 0"],
       correctAnswer: 1,
       topic: "Bitmask",
       difficulty: "Medium",
       explanation: "A power of 2 has only one bit set. N-1 flips all bits after that bit. Their AND is zero."
    },
    {
       id: 21,
       title: "Linked List: Floyd's Detection",
       description: "In Floyd's Cycle-Finding algorithm (Tortoise and Hare), how many steps does the fast pointer move relative to the slow pointer?",
       options: ["Identical", "Twice as fast", "Half as fast", "Three times as fast"],
       correctAnswer: 1,
       topic: "Linked Lists",
       difficulty: "Medium",
       explanation: "The fast pointer moves 2 steps while slow moves 1 step; if there's a cycle, they eventually meet."
    },
    {
       id: 22,
       title: "Graph: Prim's Algorithm",
       description: "What does Prim's algorithm find in a graph?",
       options: ["Shortest Path", "Minimum Spanning Tree", "Max Flow", "Bipartite Matching"],
       correctAnswer: 1,
       topic: "Graphs",
       difficulty: "Medium",
       explanation: "Prim's is a greedy algorithm that finds a Minimum Spanning Tree for a weighted undirected graph."
    },
    {
       id: 23,
       title: "String: KMP Algorithm",
       description: "What is the primary purpose of the 'LPS' (Longest Prefix Suffix) array in KMP?",
       options: ["To skip unnecessary comparisons", "To sort the pattern", "To reverse the string", "To count character frequencies"],
       correctAnswer: 0,
       topic: "Strings",
       difficulty: "Medium",
       explanation: "The LPS array helps to avoid resetting the pattern pointer back to start after a partial match."
    },
    {
       id: 24,
       title: "DP: Fibonacci Space",
       description: "How many variables are needed to calculate the Nth Fibonacci number in O(1) space?",
       options: ["1", "2", "3", "N"],
       correctAnswer: 2,
       topic: "DP",
       difficulty: "Medium",
       explanation: "We only need to track the current, previous, and next (temporary) values."
    },
    {
       id: 25,
       title: "Recursion: Tower of Hanoi",
       description: "How many moves are required for N disks in Tower of Hanoi?",
       options: ["N", "2N - 1", "2^N - 1", "N^2"],
       correctAnswer: 2,
       topic: "Recursion",
       difficulty: "Medium",
       explanation: "The recurrence is T(N) = 2T(N-1) + 1, which solves to 2^N - 1."
    },
    {
       id: 26,
       title: "Stack: Postfix Evaluation",
       description: "What is the value of the postfix expression '5 3 4 * + 2 -'?",
       options: ["15", "18", "10", "22"],
       correctAnswer: 0,
       topic: "Stacks",
       difficulty: "Medium",
       explanation: "5 + (3 * 4) - 2 = 5 + 12 - 2 = 15."
    },
    {
       id: 27,
       title: "Binary Search: Lower Bound",
       description: "In a sorted array [1, 2, 4, 4, 5, 8], what is the 0-indexed position of the lower bound of 4?",
       options: ["2", "3", "4", "5"],
       correctAnswer: 0,
       topic: "Binary Search",
       difficulty: "Medium",
       explanation: "Lower bound is the first index where element is >= target. Here, it is index 2."
    },
    {
       id: 28,
       title: "Graph: Kruskal's",
       description: "Which data structure is essential for implementing Kruskal's algorithm efficiently?",
       options: ["Max-Heap", "Disjoint Set Union (DSU)", "Queue", "AVL Tree"],
       correctAnswer: 1,
       topic: "Graphs",
       difficulty: "Medium",
       explanation: "DSU allows efficient cycle detection (Union-Find) while merging edges for MST."
    },
    {
       id: 29,
       title: "Array: Kadane's",
       description: "What does Kadane's algorithm compute?",
       options: ["Sorted Array", "Maximum Subarray Sum", "Reverse of array", "Median of array"],
       correctAnswer: 1,
       topic: "Arrays",
       difficulty: "Medium",
       explanation: "Kadane's finds the contiguous subarray within a one-dimensional array which has the largest sum."
    },
    {
       id: 30,
       title: "Memory: Stack vs Heap",
       description: "Which memory area is typically used for local variables in a function call?",
       options: ["Heap", "Stack", "Data Segment", "Code Segment"],
       correctAnswer: 1,
       topic: "Systems",
       difficulty: "Medium",
       explanation: "Local variables are stored on the stack and automatically cleared when the function returns."
    }
  ];

  useEffect(() => {
    // Randomize order if needed, or just set
  ...
  const getLeaderboardRank = (score: number) => {
    ...
    const baseRank = 5000;
    const offset = Math.floor((30 - score) * 150);
    return Math.max(1, baseRank - (score * 120) + offset);
  };
      ...
      <div className="fixed inset-0 z-[100] bg-brand-bg flex items-center justify-center p-4 transition-colors duration-300">
        ...
        >
          ...
          <p className="text-slate-400 text-lg font-medium italic mb-12 uppercase tracking-widest leading-relaxed">
            ...
            30 Medium-tier DSA challenges await.
          </p>
      ...
      <div className="fixed inset-0 z-[100] bg-brand-bg flex flex-col p-4 md:p-10 transition-colors duration-300">
        <div className="max-w-5xl mx-auto w-full flex-grow flex flex-col pt-20">
           ...
           <div className="flex justify-between items-end mb-10">
              <div>
                 <p className="text-blue-500 text-[10px] font-black uppercase tracking-[0.2em] italic mb-2">Node Verification {currentQIndex + 1}/30</p>
                 <h3 className="text-2xl md:text-4xl font-black text-white italic tracking-tighter uppercase">{q.topic} Protocol</h3>
              </div>
    ...
    <div className="fixed inset-0 z-[100] bg-brand-bg overflow-y-auto transition-colors duration-300">
       <div className="max-w-6xl mx-auto px-4 md:px-10 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
             {[
                { label: 'Neural Score', val: `${score}/30`, sub: `${((score/30)*100).toFixed(0)}% Accuracy`, icon: <Zap className="text-yellow-400" /> },
                ...
                { label: 'Logic Tier', val: score > 25 ? 'Tier 1' : score > 15 ? 'Tier 2' : 'Tier 3', sub: 'Calculated Capability', icon: <Brain className="text-fuchsia-500" /> },
             ].map((stat, i) => (
