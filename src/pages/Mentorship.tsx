...
export function Mentorship() {
  ...
  const mentors = [
    { name: "Rohit Kumar", role: "AI & Machine Learning", field: "Engineer", company: "Google", rating: 4.9, sessions: 120, img: "R" },
    { name: "Mimansa Saini", role: "Investment Strategy", field: "Finance", company: "Meta", rating: 5.0, sessions: 85, img: "M" },
    { name: "Om Mishra", role: "Full Stack Engineering", field: "Engineer", company: "Netflix", rating: 4.8, sessions: 210, img: "O" },
    { name: "Sarah Jenkins", role: "Cardiology", field: "Medical", company: "Mayo Clinic", rating: 4.9, sessions: 150, img: "S" },
    { name: "David Wu", role: "Risk Management", field: "Bank", company: "Goldman Sachs", rating: 4.7, sessions: 95, img: "D" },
    { name: "Elena Rodriguez", role: "Public Policy", field: "Civil Service", company: "UN", rating: 4.9, sessions: 64, img: "E" }
  ];
    ...
    <div className="pt-32 pb-20 px-4 min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          {['All', 'Engineer', 'Finance', 'Medical', 'Bank', 'Civil Service'].map(field => (
            <button
              key={field}
