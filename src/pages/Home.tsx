    ...
    <div className="overflow-hidden relative">
          ...
          >
            ...
            <div className="relative mb-12">
              <h1 className={`text-6xl md:text-[11vw] font-black leading-[0.85] tracking-[-0.04em] uppercase text-white ${theme === 'light' ? 'drop-shadow-[0_4px_20px_rgba(59,130,246,0.15)]' : 'drop-shadow-[0_0_30px_rgba(59,130,246,0.3)]'}`}>
                Neural <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-600">Architects</span>
              </h1>
      ...
      <section className="py-20 px-4 bg-indigo-900/5">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    { name: "John Smith", role: "Frontend Developer at Google", quote: "Credora's Skill DNA mapping helped me identify exactly what I was missing. Within 2 months, I landed my dream job." },
                    { name: "Sarah Chen", role: "HR Manager at TechFlow", quote: "We've stopped manually screening resumes. Credora's reverse hiring system brings us pre-verified talent instantly." },
                    { name: "Arun Kumar", role: "Student at IIT Delhi", quote: "The mentorship system is incredible. I got to chat with senior leads who guided my project choices." }
                ].map((t, i) => (
