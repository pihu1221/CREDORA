...
import { 
  ...
  LogOut, PlusCircle, BadgeCheck, FileUp, FileText, BrainCircuit, Loader2, Send, BookOpen
} from "lucide-react";
...
export function RecruiterDashboard() {
  ...
  const candidates = [
    { id: 's1', name: "Jane Doe", role: "Senior Frontend Lead", field: "Engineer", score: 98, fieldMastery: "99% Neural Sync", skills: ["React", "TypeScript", "Node.js"], status: "Ready to Interview", img: "J" },
    { id: 's2', name: "Alex Thompson", role: "Hedge Fund Analyst", field: "Finance", score: 92, fieldMastery: "94% HFT Protocol", skills: ["Next.js", "Python", "Risk Modeling"], status: "Shortlisted", img: "A" },
    { id: 's3', name: "Sarah Miller", role: "Resident Doctor", field: "Medical", score: 88, fieldMastery: "90% Genomic Auth", skills: ["Diagnostics", "Patient Care", "EMR"], status: "Top 5%", img: "S" },
    { id: 's4', name: "David Chen", role: "Credit Risk Manager", field: "Bank", score: 85, fieldMastery: "88% Strategic Risk", skills: ["Financial Analysis", "IFRS 9", "Credit Models"], status: "Active", img: "D" },
    { id: 's5', name: "Maya Patel", role: "Assistant Commissioner", field: "Civil Service", score: 94, fieldMastery: "96% Crisis Gov", skills: ["Policy Design", "Public Relations", "Crisis Mgt"], status: "Ready to Interview", img: "M" }
  ];

  const handleContact = (candidate: typeof candidates[0]) => {
    ...
    notifications.push({
      ...
      message: `A recruiter from Global Neural Systems is interested in your profile for a ${candidate.role} position in the ${candidate.field} field.`,
      timestamp: new Date().toISOString(),
      read: false
    });
    localStorage.setItem('credo_notifications', JSON.stringify(notifications));
    alert(`Interaction simulated: Notification sent to ${candidate.name}`);
  };
                             ...
                             >
                                <td className="px-8 py-6">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <div>
                                         ...
                                         <p className="text-gray-500 text-xs font-medium">{c.role}</p>
                                      </div>
                                   </div>
                                </td>
                                <td className="px-8 py-6">
                                ...
                                <td className="px-8 py-6 text-right">
                                   <div className="flex justify-end gap-2">
                                      ...
                                      <button className="p-2 glass rounded-lg hover:bg-white/10 transition-colors text-gray-400 hover:text-white" title="View Profile">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="glass p-8 rounded-[2rem] border border-white/5 bg-indigo-600/5 relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <p className="text-white font-bold text-xl uppercase italic leading-none">5 Master Fields</p>
                      <p className="text-slate-500 text-[10px] uppercase font-bold tracking-widest mt-1">Verified Curriculums</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    {['Engineer', 'Finance', 'Medical', 'Bank', 'Civil Service'].map(f => (
